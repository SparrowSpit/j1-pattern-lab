...
(function ($, F) {
    ...
    F.Column = F.Class.extend(/** @lends FooTable.Column */{
		 ...
		 */
        $create: function () {
            (this.$el = !this.virtual && F.is.jq(this.$el) ? this.$el : $('<th scope="col"/>')).html(this.title).addClass(this.classes.join(' ')).css(this.style);
        },
        /**
...
(function ($, F) {
    F.Filtering = F.Component.extend(/** @lends FooTable.Filtering */{
        ...
        $create: function () {
            ...
            self.$cell = $('<th scope="col"/>').attr('colspan', self.ft.columns.visibleColspan).appendTo(self.$row);
...
(function ($, F) {
    ...
    F.EditingColumn = F.Column.extend(/** @lends FooTable.EditingColumn */{
		 ...
		 */
        $create: function () {
            (this.$el = !this.virtual && F.is.jq(this.$el) ? this.$el : $('<th scope="col"/>', { 'class': 'footable-editing' })).html(this.title);
        },
        /**
